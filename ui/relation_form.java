...
public class relation_form extends JFrame {
	...
	private static String[] relation_names = {"Father" , "Mother" , "Son" , "Daughter" , "Husband" , "Wife" , "Brother" , "Sister"};
	...
	//Relationships rel = Relationships.valueOf(relation_names);
	...
	public relation_form() {
		...
		JComboBox comboBox = new JComboBox(relation_names);
		comboBox.addItemListener(new ItemListener(){
			public void itemStateChanged(ItemEvent event){
				
				
				if(event.getStateChange() == ItemEvent.SELECTED)
					Relationships rel = Relationships.valueOf(relation_names[JComboBox.getSelectedIndex()]);
